...
<body background="images\90.jpg">
  ...
  <center><font color="brown" size="6"><b>RAILWAY RESERVATION</b></font></center>
  <br><br>
</div>
  ...
  <span class="align-middle" >
    ...
    <div class="colcol-lg-2" style="background-color:#ffffff; padding:40px; border-color:#230237; border-style: solid;border-width: thin;">
      <form method="POST" action="varifyuser.php">
              <div class="form-group">
                  <label for="exampleInputName"><b>USER NAME</b></label>
                  <input type="string" class="form-control" id="username" aria-describedby="emailHelp" placeholder="Enter Your Name" name="username" required>
