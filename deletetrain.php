    ...
    <div class="colcol-lg-2" style="background-color:#ffffff; padding:40px; border-color:#230237; border-style: solid;border-width: thin;">
      <form method="POST" Action="savedelete.php">
              ...
              <div class="form-group">
                  ...
                  <input type="text" class="form-control" placeholder="ID OF TRAIN TO BE REMOVED" name="tid">
                 
              </div>
              <div class="form-group">
                  <label for="exampleInputSTATION">TRAIN NAME</label>
                  <input type="text" class="form-control"  placeholder="NAME OF TRAIN" name="tname">
